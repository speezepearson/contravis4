import { z } from 'zod';
import { FoilRelationshipSchema, resolveRelationship, type Beats } from '../contraCore';
...
export const boxTheGnatAnimator: InstructionAnimator<BoxTheGnatInstruction> = (init, who, instr) => {
